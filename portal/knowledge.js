// ========== knowledge.js - Модуль База Знаний (с поддержкой поиска по запросу) ==========
...
const knowledgeBase = [
    {
        ...
        keywords: ["звонок", "приём", "телефон", "клиент", "приветствие", "алгоритм", "конверсия"]
    },
    {
        id: 2,
        ...
        keywords: ["заявка", "crm", "составление", "оформление", "адрес", "цена", "конверсия"]
    },
    {
        id: 3,
    ...
    },
    {
        ...
        keywords: ["оплата", "деньги", "чек", "расчёт", "закрытие", "заявка", "касса"]
    },
    {
        id: 6,
    ...
    },
    {
        ...
        keywords: ["возражения", "клиент", "цена", "доводы", "сомнения", "скрипт", "конверсия"]
    },
    {
        id: 9,
        ...
        keywords: ["повторная", "продажа", "клиент", "скидка", "база", "касса"]
    },
    {
        id: 10,
...
const synonyms = {
    "звонок": ["телефон", "звонок", "приём обращения", "обращение", "трубка", "консультация"],
    ...
    "конверсия": ["конверсия", "продажи", "эффективность", "успех", "лид"],
...
// ========== ФУНКЦИЯ ДЛЯ ОТКРЫТИЯ С АВТО-ПОИСКОМ ==========
function showKnowledgeWithSearch(query) {
    showKnowledge();
    setTimeout(() => {
...
window.showKnowledgeWithSearch = showKnowledgeWithSearch;