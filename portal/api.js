...
const API_URL = 'https://script.google.com/macros/s/AKfycbzR7oazEX-nOugELbyX2gBbV6UG30dAPtoLVQTegZqwzEyvZOCY5EHl0N8mHzgtnW8e/exec'; // ← СЮДА ВСТАВЬТЕ ВАШ URL
...
async function updateAdaptationData(phone, week, block_name, calls, conversion, revenue) {
    return await apiCall('updateAdaptationData', { phone, week, block_name, calls, conversion, revenue });
}